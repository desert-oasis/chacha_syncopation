...
/*FROM: https://en.wikipedia.org/wiki/Salsa20*/
...
void ECRYPT_statesetup32(ECRYPT_ctx *x,const uint32_t randS[16]){
	for(int i=0;i<16;i++) x->input[i]=randS[i];
}